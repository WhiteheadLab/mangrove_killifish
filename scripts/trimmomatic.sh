...
java -jar /share/apps/Trimmomatic-0.36/trimmomatic.jar PE $DIR/SRR69$SLURM_ARRAY_TASK_ID\_1.fastq.gz \
	$DIR/SRR69$SLURM_ARRAY_TASK_ID\_2.fastq.gz $outdir/SRR69$SLURM_ARRAY_TASK_ID\_1.qc.fq.gz \
